...
<div>
  ...
  <div class="invoice-step" v-if="invoiceStep === 3">
       ...
       <solar-button @button:click="submitInvoice">Sumit Invoice</solar-button>
       <hr/>
          ...
          <div class="invoice-logo">
            ...
            <div class="invoice-order-list" v-if="lineItems.length">
                <div class="invoice-header">
                    ...
                    <h3>
                      {{this.selectedCustomer.primaryAddress.coutry}}
                    </h3>
                </div>
...
<script lang="ts">
  ...
  @Component({
    name: "CreateInvoice", components:{SolarButton}
  })
